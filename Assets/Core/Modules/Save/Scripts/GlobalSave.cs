...
namespace Core
{
    ...
    public class GlobalSave
    {
        ...
        public T GetSaveObject<T>(int hash) where T : ISavable, new()
        {
        ...
        public T GetSaveObject<T>(string uniqueName) where T : ISavable, new()
        {
            return GetSaveObject<T>(uniqueName.GetHashCode());
        }

        public T GetSaveObject<T>() where T : ISavable, new()
        {
