...
namespace Core
{
    ...
    public static class SaveController
    {
        ...
        public static T GetSaveObject<T>(int hash) where T : ISavable, new()
        {
            if (!isSaveLoaded)
            {
        ...
        public static T GetSaveObject<T>() where T : ISavable, new()
        {
            return GetSaveObject<T>(typeof(T).ToString().GetHashCode());
        }

        public static T GetSaveObject<T>(string uniqueName) where T : ISavable, new()
        {
